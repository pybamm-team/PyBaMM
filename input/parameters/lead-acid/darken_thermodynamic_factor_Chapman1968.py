...
def darken_thermodynamic_factor_Chapman1968(c_e):
    """
    Dimensional Darken thermodynamic factor in the electrolyte [-], from data in [1, 2],
    as a function of the electrolyte concentration c_e [mol.m-3].
    ...
    [2] KS Pitzer, RN Roy, and LF Silvester. Thermodynamics of electrolytes. 7. sulfuric
    acid. Journal of the American Chemical Society, 99(15):4930–4936, 1977.
