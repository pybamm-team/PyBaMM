...
class Sulzer2019(AbstractBaseParameters):
    ...
    def __init__(self):
        ...
        self._negative_electrode = {
            ...
            "Negative electrode open-circuit potential [V]": self.lead_ocp_Bode1977,
            ...
            "": self.lead_exchange_current_density_Sulzer2019,
        ...
        self._positive_electrode = {
            ...
            "Positive electrode open-circuit potential [V]": self.lead_dioxide_ocp_Bode1977,
            ...
            "": self.lead_dioxide_exchange_current_density_Sulzer2019,
            "Positive electrode oxygen exchange-current density [A.m-2]"
            "": self.oxygen_exchange_current_density_Sulzer2019,
        ...
        self._electrolyte = {
            ...
            "Electrolyte conductivity [S.m-1]": self.conductivity_Gu1997,
            "Darken thermodynamic factor": self.darken_thermodynamic_factor_Chapman1968,
            "Electrolyte diffusivity [m2.s-1]": self.diffusivity_Gu1997,
    ...
    def lead_dioxide_exchange_current_density_Sulzer2019(c_e, T):
        ...
        c_w_dim = (
            1 - c_e * param.V_e - c_ox * param.V_ox - c_hy * param.V_hy
        ) / param.V_w
