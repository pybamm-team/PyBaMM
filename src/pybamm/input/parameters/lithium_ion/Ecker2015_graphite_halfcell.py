...
class Ecker2015GraphiteHalfCell(AbstractBaseParameters):
    ...
    def __init__(self):
        ...
        self._positive_electrode = {
            ...
            "Positive particle diffusivity [m2.s-1]": self.graphite_diffusivity_Ecker2015,
            "Positive electrode OCP [V]": self.graphite_ocp_Ecker2015,
    ...
    def electrolyte_conductivity_Ecker2015(c_e, T):
        ...
        return C * sigma_e_296 * pybamm.exp(-E_k_e / (pybamm.constants.R * T)) / T
