...
class Kim2020NCA(AbstractBaseParameters):
    def __init__(self):
        ...
        self._negative_electrode = {
            ...
            "Negative particle diffusivity [m2.s-1]": self.graphite_diffusivity_Kim2011,
            "Negative electrode OCP [V]": self.graphite_ocp_Kim2011,
            ...
            "": self.graphite_electrolyte_exchange_current_density_Kim2011,
        ...
        self._positive_electrode = {
            ...
            "Positive particle diffusivity [m2.s-1]": self.nca_diffusivity_Kim2011,
            "Positive electrode OCP [V]": self.nca_ocp_Kim2011,
            ...
            "": self.nca_electrolyte_exchange_current_density_Kim2011,
        ...
        self._electrolyte = {
            ...
            "Electrolyte diffusivity [m2.s-1]": self.electrolyte_diffusivity_Kim2011,
            "Electrolyte conductivity [S.m-1]": self.electrolyte_conductivity_Kim2011,
        }
    ...
    @staticmethod
    def graphite_electrolyte_exchange_current_density_Kim2011(
...
def get_parameter_values():
    ...
    """
    return Kim2020NCA().get_param_set()
