...
class Prada2013(AbstractBaseParameters):
    ...
    def __init__(self):
        ...
        self._positive_electrode = {
            ...
            "Positive electrode OCP [V]": self.LFP_ocp_Afshar2017,
            ...
            "": self.LFP_electrolyte_exchange_current_density_kashkooli2017,
        ...
        self._electrolyte = {
            ...
            "Electrolyte conductivity [S.m-1]": self.electrolyte_conductivity_Prada2013,
        }
