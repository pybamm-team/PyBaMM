...
class Chen2020Composite(AbstractBaseParameters):
    def __init__(self):
        ...
        self._negative_electrode = {
            ...
            "Primary: Negative electrode OCP [V]": self.graphite_ocp_Enertech_Ai2020,
            ...
            "": self.silicon_ocp_lithiation_Mark2016,
            "Secondary: Negative electrode delithiation OCP [V]"
            "": self.silicon_ocp_delithiation_Mark2016,
            ...
            "": self.silicon_LGM50_electrolyte_exchange_current_density_Chen2020,
