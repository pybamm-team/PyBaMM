...
class OKane2022(AbstractBaseParameters):
    def __init__(self):
        ...
        self.graphite_LGM50_ocp_Chen2020_data = pybamm.parameters.process_1D_data(
        ...
        self._plating = {
            ...
            "": self.plating_exchange_current_density_OKane2020,
            "Exchange-current density for stripping [A.m-2]"
            "": self.stripping_exchange_current_density_OKane2020,
            "Initial plated lithium concentration [mol.m-3]": 0.0,
            "Typical plated lithium concentration [mol.m-3]": 1000.0,
            "Lithium plating transfer coefficient": 0.65,
            "Dead lithium decay constant [s-1]": 1e-06,
            "Dead lithium decay rate [s-1]": self.SEI_limited_dead_lithium_OKane2022,
        }
        ...
        self._negative_electrode = {
            ...
            "Negative particle diffusivity [m2.s-1]": self.graphite_LGM50_diffusivity_Chen2020,
            ...
            "Negative electrode volume change": self.graphite_volume_change_Ai2020,
            ...
            "Negative electrode cracking rate": self.graphite_cracking_rate_Ai2020,
        ...
        self._positive_electrode = {
            ...
            "Positive particle diffusivity [m2.s-1]": self.nmc_LGM50_diffusivity_Chen2020,
            ...
            "Positive electrode volume change": self.volume_change_Ai2020,
            ...
            "Positive electrode cracking rate": self.cracking_rate_Ai2020,
        ...
        self._electrolyte = {
            ...
            "": self.electrolyte_diffusivity_Nyman2008_arrhenius,
            "Electrolyte conductivity [S.m-1]"
            "": self.electrolyte_conductivity_Nyman2008_arrhenius,
        }
    ...
    def graphite_LGM50_ocp_Chen2020(self, sto):
        name, (x, y) = self.graphite_LGM50_ocp_Chen2020_data
...
def get_parameter_values():
    ...
    """
    return OKane2022().get_param_set()
