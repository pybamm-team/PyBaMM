...
class Xu2019(AbstractBaseParameters):
    def __init__(self):
        ...
        self._positive_electrode = {
            ...
            "Positive electrode OCP [V]": self.nmc_ocp_Xu2019,
            ...
            "": self.nmc_electrolyte_exchange_current_density_Xu2019,
        ...
        self._electrolyte = {
            ...
            "Electrolyte diffusivity [m2.s-1]": self.electrolyte_diffusivity_Valoen2005,
            "Electrolyte conductivity [S.m-1]": self.electrolyte_conductivity_Valoen2005,
