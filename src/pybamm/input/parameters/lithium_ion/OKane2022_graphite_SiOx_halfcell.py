...
class OKane2022GraphiteSiOxHalfCell(AbstractBaseParameters):
    def __init__(self):
        super().__init__()
        ...
        self._negative_electrode = {
            ...
            "": self.li_metal_electrolyte_exchange_current_density_Xu2019,
        ...
        self._positive_electrode = {
            ...
            "Positive particle diffusivity [m2.s-1]": self.graphite_LGM50_diffusivity_Chen2020,
            "Positive electrode OCP [V]": self.graphite_LGM50_ocp_Chen2020,
            ...
            "Positive electrode volume change": self.graphite_volume_change_Ai2020,
            ...
            "Positive electrode cracking rate": self.graphite_cracking_rate_Ai2020,
...
def get_parameter_values():
    ...
    """
    return OKane2022GraphiteSiOxHalfCell().get_param_set()
