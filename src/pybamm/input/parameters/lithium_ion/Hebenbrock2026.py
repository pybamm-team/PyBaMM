...
def graphite_CircularLIB_ocp_Hebenbrock2025(sto):
    ...
    """
    u_eq = (
        - 1.230130877183463e+03 * sto**9
        + 5.269131139767095e+03 * sto**8
        - 9.667028448586449e+03 * sto**7
        + 9.920895571681862e+03 * sto**6
        - 6.239925663346142e+03 * sto**5
        + 2.479205053606367e+03 * sto**4
        - 6.199144563918534e+02 * sto**3
        + 94.840048789313710 * sto**2
        - 8.496726235715633 * sto
        + 0.200992370674797 + 0.3545045 # last addition is potential shift from lithatited gold refence electrode to Li+/Li
    )
...
def nmc_CircularLIB_ocp_Hebenbrock2025(sto):
    ...
    u_eq = (
        ...
        + 104.1824 + 0.3545045 # last addition is potential shift from lithatited gold refence electrode to Li+/Li
    )
