...
class Ai2020(AbstractBaseParameters):
    ...
    def __init__(self):
        ...
        self.graphite_ocp_Enertech_Ai2020_data = pybamm.parameters.process_1D_data(
            "graphite_ocp_Enertech_Ai2020.csv", path=path
        )
        self.lico2_ocp_Ai2020_data = pybamm.parameters.process_1D_data(
        ...
        self._negative_electrode = {
            ...
            "Negative electrode OCP [V]": self.graphite_ocp_Enertech_Ai2020,
        ...
        self._positive_electrode = {
            ...
            "Positive electrode OCP [V]": self.lico2_ocp_Ai2020,
            ...
            "Positive electrode volume change": self.lico2_volume_change_Ai2020,
            ...
            "Positive electrode cracking rate": self.lico2_cracking_rate_Ai2020,
        ...
        self._electrolyte = {
            ...
            "Thermodynamic factor": self.dlnf_dlnc_Ai2020,
            "Electrolyte diffusivity [m2.s-1]": self.electrolyte_diffusivity_Ai2020,
            "Electrolyte conductivity [S.m-1]": self.electrolyte_conductivity_Ai2020,
        }
    ...
    @staticmethod
    def lico2_electrolyte_exchange_current_density_Dualfoil1998(
        c_e, c_s_surf, c_s_max, T
    ):
        """
    ...
    def electrolyte_diffusivity_Ai2020(c_e, T):
        ...
        :class:`pybamm.Symbol`
            Solid diffusivity
        """
        return 10 ** (-4.43 - 54 / (T - 229 - 5e-3 * c_e) - 0.22e-3 * c_e)
    ...
    def graphite_ocp_Enertech_Ai2020(self, sto):
        name, (x, y) = self.graphite_ocp_Enertech_Ai2020_data
        return pybamm.Interpolant(x, y, sto, name=name, interpolator="cubic")

    def lico2_ocp_Ai2020(self, sto):
        name, (x, y) = self.lico2_ocp_Ai2020_data
        return pybamm.Interpolant(x, y, sto, name=name, interpolator="cubic")
