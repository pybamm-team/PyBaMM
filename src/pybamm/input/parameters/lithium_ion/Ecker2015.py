...
class Ecker2015(AbstractBaseParameters):
    def __init__(self):
        ...
        self._negative_electrode = {
            ...
            "Negative particle diffusivity [m2.s-1]": self.graphite_diffusivity_Ecker2015,
            "Negative electrode OCP [V]": self.graphite_ocp_Ecker2015,
            ...
            "": self.graphite_electrolyte_exchange_current_density_Ecker2015,
        ...
        self._positive_electrode = {
            ...
            "Positive particle diffusivity [m2.s-1]": self.nco_diffusivity_Ecker2015,
            "Positive electrode OCP [V]": self.nco_ocp_Ecker2015,
            ...
            "": self.nco_electrolyte_exchange_current_density_Ecker2015,
        ...
        self._electrolyte = {
            ...
            "Electrolyte diffusivity [m2.s-1]": self.electrolyte_diffusivity_Ecker2015,
            "Electrolyte conductivity [S.m-1]": self.electrolyte_conductivity_Ecker2015,
        }
    ...
    @staticmethod
    def graphite_electrolyte_exchange_current_density_Ecker2015(
    ...
    def electrolyte_diffusivity_Ecker2015(c_e, T):
        ...
        :class:`pybamm.Symbol`
            Solid diffusivity
        """
        # The diffusivity depends on the electrolyte conductivity
    ...
    def electrolyte_conductivity_Ecker2015(c_e, T):
        ...
        return C * sigma_e_296 * np.exp(-E_k_e / (pybamm.constants.R * T)) / T
