...
class ORegan2022(AbstractBaseParameters):
    def __init__(self):
        ...
        self._thermal = {
            ...
            "": self.copper_heat_capacity_CRC,
            "Positive current collector specific heat capacity [J.kg-1.K-1]"
            "": self.aluminium_heat_capacity_CRC,
            "Negative current collector thermal conductivity [W.m-1.K-1]"
            "": self.copper_thermal_conductivity_CRC,
            "Positive current collector thermal conductivity [W.m-1.K-1]": 237.0,
            "Negative electrode specific heat capacity [J.kg-1.K-1]"
            "": self.graphite_LGM50_heat_capacity_ORegan2022,
            "Negative electrode thermal conductivity [W.m-1.K-1]"
            "": self.graphite_LGM50_thermal_conductivity_ORegan2022,
            "Positive electrode specific heat capacity [J.kg-1.K-1]"
            "": self.nmc_LGM50_heat_capacity_ORegan2022,
            "Positive electrode thermal conductivity [W.m-1.K-1]"
            "": self.nmc_LGM50_thermal_conductivity_ORegan2022,
            "Separator thermal conductivity [W.m-1.K-1]": 0.3344,
            "Separator specific heat capacity [J.kg-1.K-1]"
            "": self.separator_LGM50_heat_capacity_ORegan2022,
        }
        ...
        self._negative_electrode = {
            ...
            "": self.graphite_LGM50_diffusivity_ORegan2022,
            "Negative electrode OCP [V]": self.graphite_LGM50_ocp_Chen2020,
            ...
            "": self.graphite_LGM50_electrolyte_exchange_current_density_ORegan2022,
            "Negative electrode density [kg.m-3]": 2060.0,
            "Negative electrode OCP entropic change [V.K-1]"
            "": self.graphite_LGM50_entropic_change_ORegan2022,
        }

        self._positive_electrode = {
            "Positive electrode conductivity [S.m-1]"
            "": self.nmc_LGM50_electronic_conductivity_ORegan2022,
            "Maximum concentration in positive electrode [mol.m-3]": 51765.0,
            "Positive particle diffusivity [m2.s-1]": self.nmc_LGM50_diffusivity_ORegan2022,
            "Positive electrode OCP [V]": self.nmc_LGM50_ocp_Chen2020,
            ...
            "": self.nmc_LGM50_electrolyte_exchange_current_density_ORegan2022,
        ...
        self._electrolyte = {
            ...
            "": self.electrolyte_transference_number_EC_EMC_3_7_Landesfeind2019,
            "Thermodynamic factor": self.electrolyte_TDF_EC_EMC_3_7_Landesfeind2019,
            "Electrolyte diffusivity [m2.s-1]"
            "": self.electrolyte_diffusivity_EC_EMC_3_7_Landesfeind2019,
            "Electrolyte conductivity [S.m-1]"
            "": self.electrolyte_conductivity_EC_EMC_3_7_Landesfeind2019,
        }
    ...
    def copper_heat_capacity_CRC(T):
        ...
        """
        return 1.445e-6 * T**3 - 1.946e-3 * T**2 + 0.9633 * T + 236
    ...
    def aluminium_heat_capacity_CRC(T):
        ...
        :class:`pybamm.Symbol`
           Specific heat capacity
        """
        return 4.503e-6 * T**3 - 6.256e-3 * T**2 + 3.281 * T + 355.7
    ...
    def copper_thermal_conductivity_CRC(T):
        ...
        """
        return -5.409e-7 * T**3 + 7.054e-4 * T**2 - 0.3727 * T + 463.6
    ...
    def electrolyte_transference_number_EC_EMC_3_7_Landesfeind2019(self, c_e, T):
        """
        ...
        return self.electrolyte_transference_number_base_Landesfeind2019(c_e, T, coeffs)

    def electrolyte_TDF_EC_EMC_3_7_Landesfeind2019(self, c_e, T):
        """
        ...
        return self.electrolyte_TDF_base_Landesfeind2019(c_e, T, coeffs)

    def electrolyte_diffusivity_EC_EMC_3_7_Landesfeind2019(self, c_e, T):
        """
        ...
        return self.electrolyte_diffusivity_base_Landesfeind2019(c_e, T, coeffs)

    def electrolyte_conductivity_EC_EMC_3_7_Landesfeind2019(self, c_e, T):
        """
        ...
        return self.electrolyte_conductivity_base_Landesfeind2019(c_e, T, coeffs)
