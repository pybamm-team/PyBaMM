...
def sic_18650_electrolyte_exchange_current_density_Zhuo2023(
    ...
    return (
        m_ref * arrhenius * c_e ** 0.5 * c_s_surf ** 0.5 * (
            c_s_max - c_s_surf
        ) ** 0.5
    )
...
def get_parameter_values():
    ...
    return {
        ...
        "Initial core-shell phase boundary location"
        "": 0.9868421, # 3.75e-6 / 3.8e-6
        # cell
