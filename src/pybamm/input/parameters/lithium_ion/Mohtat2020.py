...
class Mohtat2020(AbstractBaseParameters):
    def __init__(self):
        super().__init__()
        ...
        self._negative_electrode = {
            ...
            "Negative particle diffusivity [m2.s-1]": self.graphite_diffusivity_PeymanMPM,
            "Negative electrode OCP [V]": self.graphite_ocp_PeymanMPM,
            ...
            "": self.graphite_electrolyte_exchange_current_density_PeymanMPM,
            "Negative electrode density [kg.m-3]": 3100.0,
            "Negative electrode OCP entropic change [V.K-1]"
            "": self.graphite_entropic_change_PeymanMPM,
        }
        ...
        self._positive_electrode = {
            ...
            "Positive particle diffusivity [m2.s-1]": self.NMC_diffusivity_PeymanMPM,
            "Positive electrode OCP [V]": self.NMC_ocp_PeymanMPM,
            ...
            "": self.NMC_electrolyte_exchange_current_density_PeymanMPM,
            "Positive electrode density [kg.m-3]": 3100.0,
            "Positive electrode OCP entropic change [V.K-1]"
            "": self.NMC_entropic_change_PeymanMPM,
        }
        ...
        self._electrolyte = {
            ...
            "Electrolyte diffusivity [m2.s-1]": self.electrolyte_diffusivity_PeymanMPM,
            "Electrolyte conductivity [S.m-1]": self.electrolyte_conductivity_PeymanMPM,
        }
    ...
    @staticmethod
    def graphite_electrolyte_exchange_current_density_PeymanMPM(
...
def get_parameter_values():
    ...
    """
    return Mohtat2020().get_param_set()
