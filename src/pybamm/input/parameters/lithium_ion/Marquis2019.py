...
class Marquis2019(AbstractBaseParameters):
    def __init__(self):
        ...
        self._negative_electrode = {
            ...
            "Negative electrode OCP [V]": self.graphite_mcmb2528_ocp_Dualfoil1998,
        ...
        self._positive_electrode = {
            ...
            "Positive electrode OCP [V]": self.lico2_ocp_Dualfoil1998,
        ...
        self._electrolyte = {
            ...
            "Electrolyte diffusivity [m2.s-1]": self.electrolyte_diffusivity_Capiglia1999,
            "Electrolyte conductivity [S.m-1]": self.electrolyte_conductivity_Capiglia1999,
        }
...
def get_parameter_values():
    ...
    """
    return Marquis2019().get_param_set()
