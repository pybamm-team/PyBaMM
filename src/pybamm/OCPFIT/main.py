...
params_list, S_config_params_list, n_list, Theta_E_list = train_multiple_OCVs_and_dS_dx(
    ...
    alpha_dsdx=1.0
    / 10000,  # weight of dsdx loss, its usually on the order of 100, so 100/10000 ~ 0.01, ~ same level of OCV loss
...
write_ocv_functions(
    ...
    T=273 + 10,
    outpyfile_name="10C.py",
)
write_ocv_functions(
    [params_list, S_config_params_list, n_list, Theta_E_list],
    T=273 + 25,
    outpyfile_name="25C.py",
)
write_ocv_functions(
    [params_list, S_config_params_list, n_list, Theta_E_list],
    T=273 + 47,
    outpyfile_name="47C.py",
)
write_ocv_functions(
    [params_list, S_config_params_list, n_list, Theta_E_list],
    T=273 + 57,
    outpyfile_name="57C.py",
)
