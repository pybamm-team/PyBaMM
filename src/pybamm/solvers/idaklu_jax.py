...
class IDAKLUJax:
    ...
    def get_var(
        ...
        *args,
        ...
        numeric (numpy.typing.NDArray) object (which returns a slice of the output).
        ...
        Parameters
        ----------
        f : Callable | numpy.typing.NDArray, optional
        ...
        numpy.typing.NDArray
            If called with a numeric (numpy.typing.NDArray) object, returns a slice of the output
    ...
    def _jax_solve_array_inputs(self, t, inputs_array):
        ...
        This version assumes all parameters are provided as numpy.typing.NDArray vectors
        """
    ...
    def _jax_solve(
        self,
        t: Union[float, numpy.typing.NDArray],
        *inputs,
    ) -> numpy.typing.NDArray:
    ...
    def _jax_jvp_impl(
        self,
        *args: Union[numpy.typing.NDArray],
    ):
    ...
    def _jax_vjp_impl(
        self,
        y_bar: numpy.typing.NDArray,
        invar: Union[str, int],  # index or name of input variable
        *primals: numpy.typing.NDArray,
    ):
