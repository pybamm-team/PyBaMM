...
class IDAKLUJax:
    ...
    def get_var(
        ...
        *args,
        ...
        numeric (npt.NDArray) object (which returns a slice of the output).
        ...
        Parameters
        ----------
        f : Callable | npt.NDArray, optional
        ...
        Callable
            ...
            where:
                ...
                inputs : dict, optional
                    ...
                    {'Current function [A]': 0.222, 'Separator porosity': 0.3}
        npt.NDArray
            If called with a numeric (npt.NDArray) object, returns a slice of the output
    ...
    def jax_value(
        ...
        Returns a numeric (npt.NDArray) object (not a JAX expression).
    ...
    def _jax_solve_array_inputs(self, t, inputs_array):
        ...
        This version assumes all parameters are provided as npt.NDArray vectors
        """
