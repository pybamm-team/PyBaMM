    ...
    **Extends:** :class:`pybamm.BaseSubModel`
    ...
    def _get_standard_concentration_variables(self, c_e):
        ...
        variables = {
            ...
            "Average electrolyte concentration [Molar]": c_e_typ * c_e_av / 1000,
            ...
            "Average negative electrolyte concentration": c_e_n_av,
            "Average negative electrolyte concentration [mol.m-3]": c_e_typ * c_e_n_av,
            "Average separator electrolyte concentration": c_e_s_av,
            "Average separator electrolyte concentration [mol.m-3]": c_e_typ * c_e_s_av,
            "Average positive electrolyte concentration": c_e_p_av,
            "Average positive electrolyte concentration [mol.m-3]": c_e_typ * c_e_p_av,
        }
