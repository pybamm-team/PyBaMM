            ...
            variables.update(
                {
                    ...
                    "Decomposition heating [W.m-3]": pybamm.Scalar(0),
                    "X-averaged decomposition heating": pybamm.Scalar(0),
                    "X-averaged decomposition heating [W.m-3]": pybamm.Scalar(0),
                    "Volume-averaged decomposition heating": pybamm.Scalar(0),
                    "Volume-averaged decomposition heating [W.m-3]": pybamm.Scalar(0),
