    ...
    *Extends:* :class:`pybamm.SubModel`
    ...
    def set_potential_pair_spm(self, bc_variables):
        ...
        self.algebraic = {
            ...
            + (param.sigma_cn * param.delta ** 2 / param.l_cn) * pybamm.source(i_boundary_cc, phi_s_cn),
            phi_s_cp: pybamm.laplacian(phi_s_cp)
            - (param.sigma_cp * param.delta ** 2 / param.l_cp) * pybamm.source(i_boundary_cc, phi_s_cp),
        ...
        self.boundary_conditions = {
            phi_s_cn: {"left": (pybamm.Scalar(0), "Dirichlet"), "right": (pybamm.Scalar(0), "Neumann")},
            phi_s_cp: {"left": (pybamm.Scalar(0), "Neumann"), "right": (pos_tab_bc, "Neumann")},
        }
        self.variables = {
