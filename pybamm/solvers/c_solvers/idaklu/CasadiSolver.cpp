...
/*
 * This is an abstract base class that implements an OpenMP solution but
 * requires a linear solver to create a concrete class. Hook functions, or
 * entire methods, are intended to be overriden to support alternative solver
 * approaches (e.g. Cuda), as needed.
 */
...
void CasadiSolver::AllocateVectors() {
  // Create vectors
