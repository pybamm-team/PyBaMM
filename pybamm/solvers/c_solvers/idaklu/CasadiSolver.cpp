...
/*
 * This is an abstract class to be inherited by CasadiSolver_XXX children that
 * implement solver functions, etc.
 */
...
void CasadiSolver::Initialize() {
    ...
    // create context (calls wrapper if Sundials Ver<6)
