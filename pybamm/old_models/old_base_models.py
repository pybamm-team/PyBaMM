...
class OldSubModel(OldStandardBatteryBaseModel):
...
class OldLeadAcidBaseModel(OldStandardBatteryBaseModel):
    """
...
class OldLithiumIonBaseModel(OldStandardBatteryBaseModel):
    """
    Overwrites default parameters from Base Model with default parameters for
    lithium-ion models
    **Extends:** :class:`StandardBatteryBaseModel`
