...
class OldMainReaction(
    pybamm.old_interface.OldInterfacialReaction, pybamm.OldLeadAcidBaseModel
):
    """
...
class OldInterfacialSurfaceArea(pybamm.OldSubModel):
    """
...
class OldVaryingSurfaceArea(OldInterfacialSurfaceArea):
    """
...
class OldConstantSurfaceArea(OldInterfacialSurfaceArea):
    """
