...
class OldElectrolyteCurrentBaseModel(pybamm.OldBaseSubModel):
    """
...
class OldMacInnesStefanMaxwell(OldElectrolyteCurrentBaseModel):
...
class OldMacInnesCapacitance(OldElectrolyteCurrentBaseModel):
    """MacInnes equation for the current in the electrolyte, derived from the
