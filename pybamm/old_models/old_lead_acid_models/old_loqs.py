...
class OldLOQS(pybamm.LeadAcidBaseModel):
    ...
    **Extends:** :class:`pybamm.LeadAcidBaseModel`
    ...
    def set_interfacial_surface_area_submodel(self):
        ...
        area_current_vars = surface_area_model.get_current_variables(self.variables)
        self.variables.update(area_current_vars)
    ...
    def set_reactions(self):
        ...
        self.reactions = {
            "main": {
                ...
                "pos": {"s": -(param.s_plus_p_S + param.t_plus), "aj": aj_p},
            }
        }
        if "oxygen" in self.options["side reactions"]:
