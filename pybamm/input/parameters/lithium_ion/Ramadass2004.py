...
def graphite_entropic_change_Moura2016(sto, c_s_max):
    ...
    """
    du_dT = (
        -1.5 * (120.0 / c_s_max) * exp(-120 * sto)
        + (0.0351 / (0.083 * c_s_max)) * ((cosh((sto - 0.286) / 0.083)) ** (-2))
        - (0.0045 / (0.119 * c_s_max)) * ((cosh((sto - 0.849) / 0.119)) ** (-2))
        - (0.035 / (0.05 * c_s_max)) * ((cosh((sto - 0.9233) / 0.05)) ** (-2))
        - (0.0147 / (0.034 * c_s_max)) * ((cosh((sto - 0.5) / 0.034)) ** (-2))
        - (0.102 / (0.142 * c_s_max)) * ((cosh((sto - 0.194) / 0.142)) ** (-2))
        - (0.022 / (0.0164 * c_s_max)) * ((cosh((sto - 0.9) / 0.0164)) ** (-2))
        - (0.011 / (0.0226 * c_s_max)) * ((cosh((sto - 0.124) / 0.0226)) ** (-2))
        + (0.0155 / (0.029 * c_s_max)) * ((cosh((sto - 0.105) / 0.029)) ** (-2))
    )
...
def lico2_entropic_change_Moura2016(sto, c_s_max):
    ...
    du_dT = (
        0.07645 * (-54.4806 / c_s_max) * ((1.0 / cosh(30.834 - 54.4806 * sto)) ** 2)
        + 2.1581 * (-50.294 / c_s_max) * ((cosh(52.294 - 50.294 * sto)) ** (-2))
        + 0.14169 * (19.854 / c_s_max) * ((cosh(11.0923 - 19.8543 * sto)) ** (-2))
        - 0.2051 * (5.4888 / c_s_max) * ((cosh(1.4684 - 5.4888 * sto)) ** (-2))
        - (0.2531 / 0.1316 / c_s_max) * ((cosh((-sto + 0.56478) / 0.1316)) ** (-2))
        - (0.02167 / 0.006 / c_s_max) * ((cosh((sto - 0.525) / 0.006)) ** (-2))
    )
...
def get_parameter_values():
 ...
 'Negative electrode exchange-current density [A.m-2]': graphite_electrolyte_exchange_current_density_Ramadass2004,
 ...
 'Positive electrode exchange-current density [A.m-2]': lico2_electrolyte_exchange_current_density_Ramadass2004,
