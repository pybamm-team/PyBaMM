...
def graphite_ocp_PeymanMPM(sto):
    ...
    u_eq = (
        0.063
        + 0.8 * pybamm.pybamm.exp(-75 * (sto + 0.001))
        - 0.0120 * pybamm.pybamm.tanh((sto - 0.127) / 0.016)
        - 0.0118 * pybamm.pybamm.tanh((sto - 0.155) / 0.016)
        - 0.0035 * pybamm.pybamm.tanh((sto - 0.220) / 0.020)
        - 0.0095 * pybamm.pybamm.tanh((sto - 0.190) / 0.013)
        - 0.0145 * pybamm.pybamm.tanh((sto - 0.490) / 0.020)
        - 0.0800 * pybamm.pybamm.tanh((sto - 1.030) / 0.055)
    )
...
def NMC_ocp_PeymanMPM(sto):
    ...
    u_eq = (
        ...
        + 3.5146 * (sto**4)
        - 2.2166 * (sto**5)
        - 0.5623e-4 * pybamm.pybamm.exp(109.451 * sto - 100.006)
    )
...
def NMC_entropic_change_PeymanMPM(sto, c_s_max):
    ...
    u_eq = (
        ...
        - 2.0843 * sto**3
        + 3.5146 * sto**4
        - 0.5623 * 10 ** (-4) * pybamm.pybamm.exp(109.451 * sto - 100.006)
    )
