...
nca_ocp_Kim2011_data_filename = pybamm.get_parameters_filepath(
    "pybamm/input/parameters/lithium_ion/nca_ocp_Kim2011_data.csv"
)
nca_ocp_Kim2011_data = pd.read_csv(nca_ocp_Kim2011_data_filename, comment="#")

# Call dict via a function to avoid errors when editing in place
def get_parameter_values():
    """
    # NCA_Kim2011 parameter set
    ...
    return {
        ...
        "Positive electrode OCP [V]": ("nca_ocp_Kim2011_data", nca_ocp_Kim2011_data),
