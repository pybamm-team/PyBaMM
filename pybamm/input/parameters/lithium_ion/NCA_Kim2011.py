...
nca_ocp_Kim2011_data_filename = pybamm.get_parameters_filepath('pybamm/input/parameters/lithium_ion/nca_ocp_Kim2011_data.csv')
nca_ocp_Kim2011_data = np.loadtxt(nca_ocp_Kim2011_data_filename, delimiter=',')
