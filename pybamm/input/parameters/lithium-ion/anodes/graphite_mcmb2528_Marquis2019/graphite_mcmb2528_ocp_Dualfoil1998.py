...
def graphite_mcmb2528_ocp_Dualfoil1998(sto):
    ...
    u_eq = (
        Scalar(0.194, "[V]")
        + Scalar(1.5, "[V]") * exp(-120.0 * sto)
        + Scalar(0.0351, "[V]") * tanh((sto - 0.286) / 0.083)
        - Scalar(0.0045, "[V]") * tanh((sto - 0.849) / 0.119)
        - Scalar(0.035, "[V]") * tanh((sto - 0.9233) / 0.05)
        - Scalar(0.0147, "[V]") * tanh((sto - 0.5) / 0.034)
        - Scalar(0.102, "[V]") * tanh((sto - 0.194) / 0.142)
        - Scalar(0.022, "[V]") * tanh((sto - 0.9) / 0.0164)
        - Scalar(0.011, "[V]") * tanh((sto - 0.124) / 0.0226)
        + Scalar(0.0155, "[V]") * tanh((sto - 0.105) / 0.029)
    )
