...
c_p_0=pybamm.Parameter("Positive electrode Reference concentration for free of deformation [m3.mol-1]")
...
c_n_0=pybamm.Parameter("Negative electrode Reference concentration for free of deformation [m3.mol-1]")
Omega_n=pybamm.Parameter("Negative electrode Partial molar volume [m3.mol-1]")

crack_flag=1  #  1 - enable crack propagation; 0 - disable cracking in battery degradation 
...
Eac_cr=pybamm.Parameter("Negative electrode Activation energy for cracking rate [kJ.mol-1]")
