...
# Electrode properties
V_Pb = pybamm.Parameter("Molar volume of lead [kg.mol-1]")
V_PbO2 = pybamm.Parameter("Molar volume of lead-dioxide [kg.mol-1]")
V_PbSO4 = pybamm.Parameter("Molar volume of lead sulfate [kg.mol-1]")
