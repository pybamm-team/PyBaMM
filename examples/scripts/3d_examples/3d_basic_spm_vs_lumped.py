...
model_3d = pybamm.lithium_ion.BasicSPM_with_3DThermal(options={"cell geometry": "box", "dimensionality": 3})
...
ax1.plot(sol_3d["Time [s]"].data, sol_3d["Voltage [V]"].data, "b-", label="3D Thermal Model")
ax1.plot(sol_lumped["Time [s]"].data, sol_lumped["Voltage [V]"].data, "r--", label="Lumped Thermal Model")
...
ax2.plot(sol_3d["Time [s]"].data, sol_3d["Volume-averaged cell temperature [K]"].data, "b-", label="3D Thermal Model (Avg)")
ax2.plot(sol_lumped["Time [s]"].data, sol_lumped["Volume-averaged cell temperature [K]"].data, "r--", label="Lumped Thermal Model")
