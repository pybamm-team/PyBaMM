...
t_slices = [600, 1200, 1800, 2400, 3000]
...
plt.savefig("neg_cc_pot_1plus1D.pdf", format="pdf", dpi=1000)
...
plt.savefig("pos_cc_pot_1plus1D.pdf", format="pdf", dpi=1000)
...
plt.savefig("current_1plus1D.pdf", format="pdf", dpi=1000)
...
plt.savefig("temperature_1plus1D.pdf", format="pdf", dpi=1000)
