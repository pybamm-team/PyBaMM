#
# Test many particle-size distributions with Fickian diffusion
#
...
class TestManySizeDistributions(unittest.TestCase):
    def test_public_functions(self):
        ...
        variables = {
            "Negative electrode interfacial current density distribution": a_n,
        ...
        submodel = pybamm.particle.FickianManySizeDistributions(param, "Negative")
        std_tests = tests.StandardSubModelTests(submodel, variables)
        std_tests.test_all()

        variables = {
            "Positive electrode interfacial current density distribution": a_p,
        ...
        submodel = pybamm.particle.FickianManySizeDistributions(param, "Positive")
        std_tests = tests.StandardSubModelTests(submodel, variables)
        std_tests.test_all()
