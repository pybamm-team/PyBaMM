#
# Test xyz-lumped submodel with 1D current collectors
#
...
class TestCurrentCollector1D(unittest.TestCase):
    def test_public_functions(self):
        ...
        submodel = pybamm.thermal.xyz_lumped.CurrentCollector1D(param)
