...
class TestKLUSolver(unittest.TestCase):
    def test_ida_roberts_klu(self):
        ...
        # test that final time is triggered by event

        # test that final value is the event value

        # test that y[2] remains constant

        # test that y[1] = to true solution

    # def test_ode_integrate_with_jacobian(self):
    #     # Linear
    #     solver = pybamm.KLU(tol=1e-8)
    ...
    #     solver = pybamm.KLU(tol=1e-8, linsolver="spgmr")
