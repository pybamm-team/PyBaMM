...
- Added a basic DFN model on 2D or 3D unstructured meshes (`BasicDFNUnstructured`), selected with the new `"mesh dimensionality"` model option. ([#5690](https://github.com/pybamm-team/PyBaMM/pull/5690))
