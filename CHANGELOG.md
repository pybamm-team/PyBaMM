...
- A `pybammsolvers` solution saved with only output variables has `y_init`, its states at the first time point after consistent initialization, alongside `y_term`. ([#5794](https://github.com/pybamm-team/PyBaMM/pull/5794))
