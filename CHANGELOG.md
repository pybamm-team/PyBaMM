...
- `ScipySolver`, `CasadiSolver`, and `CasadiAlgebraicSolver` are deprecated; use `IDAKLUSolver` (or `NonlinearSolver` for algebraic systems) instead. It is now the default for every model. ([#XXXX](https://github.com/pybamm-team/PyBaMM/pull/XXXX))
