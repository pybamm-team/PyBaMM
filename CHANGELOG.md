...
- `ElectrodeSOHComposite` now solves each stoichiometry by bracketed rootfind, converging from any target. ([#5730](https://github.com/pybamm-team/PyBaMM/pull/5730))
