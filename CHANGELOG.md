...
- Direct time interpolants used as function parameters now inherit their supplied time domain, so isothermal models solve with nonlinear electrolyte parameters. ([#3630](https://github.com/pybamm-team/PyBaMM/issues/3630), [#4670](https://github.com/pybamm-team/PyBaMM/issues/4670))
